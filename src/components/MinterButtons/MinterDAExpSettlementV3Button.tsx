...
import MinterDAExpSettlementV3ABI from "abi/V3/MinterDAExpSettlementV3.json"
...
const MinterDAExpSettlementV3Button = (
  {
    coreContractAddress,
    mintContractAddress,
    projectId,
  ...
  const { config } = usePrepareContractWrite({
    ...
    abi: MinterDAExpSettlementV3ABI,
...
export default MinterDAExpSettlementV3Button
