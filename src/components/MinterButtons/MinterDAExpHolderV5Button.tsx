...
import MinterDAExpHolderV5ABI from "abi/V5/MinterDAExpHolderV5.json"
...
const MinterDAExpHolderV5Button = (
  {
    coreContractAddress,
    mintContractAddress,
    projectId,
...
export default MinterDAExpHolderV5Button
