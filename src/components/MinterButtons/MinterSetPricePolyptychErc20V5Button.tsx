...
import MinterSetPricePolyptychERC20V5 from "abi/V5/MinterSetPricePolyptychERC20V5.json"
...
const MinterSetPricePolyptychErc20V5Button = (
  {
    coreContractAddress,
    mintContractAddress,
    projectId,
...
export default MinterSetPricePolyptychErc20V5Button
